...
String sgpa1=request.getParameter("sgpa2");
String cgpa1=request.getParameter("cgpa2");
String myloc=request.getParameter("sem2");
...
String q="select name from sem2";
...
if(c==0)
{
String q2="insert into sem2(name) values('"+s1+"')";
st.executeUpdate(q2);
}
...
pstmt = conn.prepareStatement("update sem2 set sgpa1=?,cgpa1=?,image=? where name='"+s1+"'");
