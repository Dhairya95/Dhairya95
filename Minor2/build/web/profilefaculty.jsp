...
<%
    String s1=(String)session.getAttribute("faculty");
    String s2=(String)session.getAttribute("facultyid");
    String s3="",s4="",s5="";
    try
    {
        ...
        String q="select name,branch,id from faculty where name='"+s1+"' and id='"+s2+"'";
...
%>  
  ...
  <div class="mid" style=" width:auto; font:left;">
    ...
    <label for="sem">ID</label><br>
    <input style="background:white;" type="text" name="id" value="<%=s5%>" readonly><br>
  ...
  <div class="imgcontainer">
      <form action="profupfac.jsp" method="get">
    <img height="250" width="300"  src="imagef.jsp" alt="student" class="avatar"><br>
