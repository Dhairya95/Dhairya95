...
<h1 style="text-align: center;">Student Registration Form</h1><br>

<div class="container">

  <form action="studentregis1.jsp" method="get">
...
<div class="image">
  ...
  <div class="mid" style="width:auto; font:left;">
    <label for="fname" class="lab">First Name</label><br>
    <input type="text" id="fname" name="fname" placeholder="Your first name.." required><br>
<label for="lname" class="lab">Last Name</label><br>
    <input type="text" id="fname" name="lname" placeholder="Your last name.." required><br>
    ...
    <label for="sem" class="lab">Semester</label><br>
    <input type="number" style="height:40px;width:390px;" id="lname" name="sem" placeholder="Your semester i.e. 1,2.." min="2" max="8" ><br><br>
