...
<body>
    <div class="header">
<div class="exit" style="float:left;">  <a href="regis.jsp"><img alt="exit" width="50" height="50" src="exit.png" ></a></div>
    ...
    <div class="row"><br>
        ...
        <h1 >Alumni Registration </h1><br>

        <div class="container">

            <form action="alumniregis1.jsp" method="post">
                <div class="image">
  <div class="imgcontainer">
    ...
    <input type="file" id="change picture" name="pic">
        ...
        <div class="mid" style="width:auto; font:left;">
            ...
            <label for="Completion Year" class="lab">Completion Year</label><br>
           <input type="number" style="height:40px;width:390px;" id="lname" name="Cy" placeholder="Year of Completion" min="2010" max="2024" required><br><br>
          
            <label for="Password" class="lab">Password</label><br>
            <input type="password" style="height:40px;width:390px;" id="Password" name="Pass" placeholder="Type here.." required><br>

            <input type="submit" value="Submit" class="sub"><br>
